...
const int sphere_count, __global float* output, int samples)
{
	...
	output[(work_item_id * 3) + 0] = finalcolor.x;
    output[(work_item_id * 3) + 1] = finalcolor.y;
    output[(work_item_id * 3) + 2] = finalcolor.z;
}