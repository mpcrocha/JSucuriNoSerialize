 ...
 */
public class SobelJSucuriStreamMultipleQueue {
    ...
    public static void main(String args[]){
        ...
        for(int i = 0; i < numIters; i++){
            ...
            copyInImageNodeList.add(new Node(copyInImage, 3));
            ...
            queueFeederList.get(i % numIters).add_edge(execKernelNodeList.get(i), 6);

            execKernelNodeList.get(i).add_edge(copyOutImageNodeList.get(i), 0);
            queueFeederList.get(i % numIters).add_edge(copyOutImageNodeList.get(i), 1);
