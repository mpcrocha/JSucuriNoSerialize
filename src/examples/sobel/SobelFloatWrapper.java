...
public class SobelFloatWrapper {
    ...
    protected void applyFilterSobel(CLContext context) throws IOException {
        ...
        int image_width = 1920;//570;
        int image_height = 1032;//881;
        ...
        String filename = "/home/marcos/Dropbox/Mestrado/tese/experimentoSobel/inputsSobel/$filename0026.bmp";
        image_input = sobelUtils.populateImage(image_input, filename);
        ...
        sobel_kernel.setArgs(inputImage, outputImage, image_width, image_height);
