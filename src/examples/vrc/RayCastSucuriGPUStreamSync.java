 ...
 * 4 1280 720 1 2 2
 */
public class RayCastSucuriGPUStreamSync {
    ...
    public static void main(String args[]){
        ...
        NodeFunction assyncCopyIN =  new NodeFunction() {
            ...
            for(int i = 0; i < data.length; i++)
                ...
                bufferData.write(queueCL, dataPointer, true);

                Object[] bufferEvents = new Object[]{bufferData, null};
        ...
        NodeFunction assyncCopyOut =  new NodeFunction() {
            ...
            public Object f(Object[] inputs) {
                ...
                int width = camera.getWidth();
                int height = camera.getHeight();
                File outputFile = new File("Outputs/output_sync_raycast" + num_output_image
        ...
        for(int i = 0; i < numIters; i++){
            ...
            Node copyOut = new Node(assyncCopyOut, 4);
